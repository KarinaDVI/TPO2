...
public class MascotaJpaController implements Serializable {
    ...
    /*Constructor para las unidades de persistencia y conexion con las 
    controladoras de JPA*. Le pasamos el nombre de unidad de persistencia*/
    
    public MascotaJpaController() {
        this.emf = Persistence.createEntityManagerFactory("Bouza_Karina_Beatriz_tpo2PU");
    }
